                                ...
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        ...
                                        <div>
                                            ...
                                            <div class="text"><strong>Saturday</strong>10.00 am to 5.00pm</div>
                                            <div class="text"><span>Friday-Closed</span></div>
                                        </div>                                    
                                    </div>
                                </div>
                            </div>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="row m-0 align-items-center justify-content-between">
                <div class="copyright-text">Copyright © 2022 <?php echo $setting['site_name']; ?> | Designed By <a target="blank" href="https://www.actwebspace.com"> Sifat Shaharia</a></div>
                <ul class="menu">
                    <li><a href="privacy.php">Privacy Policies</a></li>
                    <li><a href="terms.php">Terms & Conditions </a></li>
