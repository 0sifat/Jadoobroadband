    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                <div class="sub-title">Broadband Services</div>
                <h4>Corporate Internet & Data Connectivity System <br> All Over Bangladesh</h4>
                <p> We are specialized to established and maintain corporate connectivity. Our high-speed plans are most suitable for Business Communication, HD online streaming and be a good companion for your smart office devices. We always try to provide maximum quality support and stable connectivity on dedicated broadband network. Jadoo broadband offers a range of solutions for any business need and budget. We offer broadband connectivity services with various value added service for corporate that require a speed broadband experience, high availability and consistency. Get connected now and feel the experience of super fast broadband connection.</p>
                <h4>Retail Internet<br> All Over Bangladesh</h4>
                <p>With such a reliance on your access to the internet, it is important that your partner with an experienced and responsive provider for your ongoing retail business needs. As a retail business, you can rely on our fully monitored, flexible and managed internet access and connectivity services to run your business critical applications, giving you the flexibility and up-time that you need to succeed.</p>
    ...
    <section class="services-section style-two ">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h4>Moving Your Products Across <br> All Borders</h4>
    ...
    <section class="services-section-two style-two mx-30">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Jadoo Offers Various Value Added <br>Services in Logisitcs</h2>
            </div>
            <div class="row">
